...
class Movies:
    ...
    def get_movies_list(self, tag, class_=None) -> list:
        ...
        :param tag: html-tag corresponding to movie titles
        :param class_: html-class corresponding to movie titles
        :return movie_list: list of movie titles
        """
    ...
    def get_genres_stat(self, tag, class_=None) -> dict:
        ...
        :param tag: html-tag corresponding to genres titles
        :param class_: html-class corresponding to genres titles 
        :return all_genre: dict of genres titles and their number
        """
    ...
    def get_rating_plot(self, tag, class_=None) -> None: 
        ...
        :param tag: html-tag corresponding to movie ratings
        :param class_: html-class corresponding to movie ratings
        :return None: ! displays a graph of ratings !
        """
    ...
    def get_release_years_plot(self, tag, class_=None) -> None:
        ...
        :param tag: html-tag corresponding to movie release years
        :param class_: html-class corresponding to movie release years
        :return None: ! displays a graph of the dependence of the rating of films on the year of release !
        """
